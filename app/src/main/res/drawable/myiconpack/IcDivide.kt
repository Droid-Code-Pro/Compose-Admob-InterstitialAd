...
public val MyIconPack.IcDivide: ImageVector
    get() {
        if (_icDivide != null) {
            return _icDivide!!
        }
        _icDivide = Builder(name = "IcDivide", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _icDivide: ImageVector? = null
